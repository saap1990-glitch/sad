...
export default function SlowMovingScreen() {
  ...
  return (
    <View style={[styles.c, { paddingTop: insets.top }]}>
      <View style={styles.h}><TouchableOpacity onPress={() => router.back()}><Text style={styles.back}>←</Text></TouchableOpacity><Text style={styles.t}>⚠️ أصناف منتهية الصلاحية</Text><View style={{width:40}}/></View>
      <View style={styles.content}><Text style={styles.placeholder}>لا توجد أصناف منتهية الصلاحية حالياً</Text></View>
    </View>
  );
}
