...
export default function AccountCurrenciesScreen() {
  ...
  return (
    <View style={[styles.c, { paddingTop: insets.top }]}>
      <View style={styles.h}><TouchableOpacity onPress={() => router.back()}><Text style={styles.back}>←</Text></TouchableOpacity><Text style={styles.t}>💱 عملات الحساب</Text><View style={{width:40}}/></View>
      <Text style={styles.placeholder}>إدارة عملات الحساب</Text>
    </View>
  );
}
