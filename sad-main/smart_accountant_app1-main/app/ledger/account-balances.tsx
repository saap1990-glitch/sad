...
export default function AccountBalancesScreen() {
  ...
  return (
    <View style={[styles.c, { paddingTop: insets.top }]}>
      <View style={styles.h}><TouchableOpacity onPress={() => router.back()}><Text style={styles.back}>←</Text></TouchableOpacity><Text style={styles.t}>💰 أرصدة الحسابات</Text><View style={{width:40}}/></View>
      <Text style={styles.placeholder}>أرصدة الحسابات</Text>
    </View>
  );
}
