...
export default function CurrencyReportsScreen() {
  ...
  return (
    <View style={[styles.c, { paddingTop: insets.top }]}>
      <View style={styles.h}><TouchableOpacity onPress={() => router.back()}><Text style={styles.back}>←</Text></TouchableOpacity><Text style={styles.t}>📊 تقارير العملات</Text><View style={{width:40}}/></View>
      <Text style={styles.placeholder}>تقارير العملات</Text>
    </View>
  );
}
